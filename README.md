...
No seu arquivo Markdown, você é livre para se expressar da forma que quiser, mas pelo bem da sua apresentação, recomendamos que você tenha no mínimo os seguintes tópicos:
...
Você pode comentar um pouco sobre a área em que você planeja seguir e quais tecnologias você está explorando. Também é válido se gabar sobre as ferramentas e linguagens de programação que só você conhece ou utiliza.

### Objetivos

Como dito anteriormente, é interessante saber quais são os seus objetivos dentro e fora do Instituto Caldeira. Então, sinta-se livre para sonhar e compartilhar como você planeja alcançá-los!
...
A inspiração para este projeto é o repositório [dio-lab-open-source](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main), da Digital Innovation One. Você pode acessá-lo para instruções mais detalhadas.
